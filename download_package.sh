...
echo "    Ouvrir: https://metaconnect-1.preview.emergentagent.com"
...
echo "    wget https://metaconnect-1.preview.emergentagent.com/TRADABOT_Package.zip"
echo ""
echo "4️⃣  Via curl:"
echo "    curl -O https://metaconnect-1.preview.emergentagent.com/TRADABOT_Package.zip"
echo ""
