...
echo "    Ouvrir: https://autotrader-hub-12.preview.emergentagent.com"
...
echo "    wget https://autotrader-hub-12.preview.emergentagent.com/TRADABOT_Package.zip"
echo ""
echo "4️⃣  Via curl:"
echo "    curl -O https://autotrader-hub-12.preview.emergentagent.com/TRADABOT_Package.zip"
echo ""
