  ...
  fr: {
    ...
    home: {
      ...
      bot: {
        ...
        price: '2$ CAD',
        preorderPrice: 'Prix de précommande : 2$ CAD',
...
• Conseils pratiques`
    ...
    subscription: {
      ...
      dashboard: {
        ...
        noSubscriptionText: 'Accédez à tous nos signaux de trading en temps réel sur Forex, Crypto, Indices et plus encore pour seulement 2$ CAD/mois',
      ...
      form: {
        ...
        firstPayment: 'Premier paiement : 2$ CAD aujourd\'hui',
  ...
  en: {
    ...
    home: {
      ...
      bot: {
        ...
        price: '2$ CAD',
        preorderPrice: 'Pre-order price: 2$ CAD',
...
• Practical advice`
    ...
    subscription: {
      ...
      dashboard: {
        ...
        noSubscriptionText: 'Access all our real-time trading signals on Forex, Crypto, Indices and more for only 2$ CAD/month',
      ...
      form: {
        ...
        firstPayment: 'First payment: 2$ CAD today',
