...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1E1540]">
      ...
      {/* Copy Trading Bot Section - EN PREMIÈRE PAGE */}
      <section className="py-20 px-4 relative overflow-hidden">
        {/* Background effects */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#2B1F5C]/30 to-transparent"></div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="bot-download-wrapper">
            ...
            {/* Contenu */}
            <div className="bot-download-content">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-white/80 mb-4">
                    {language === 'fr' 
                      ? 'Copiez automatiquement nos signaux sur votre compte MetaTrader 4 avec gestion personnalisée des lots'
                      : 'Automatically copy our signals to your MetaTrader 4 account with personalized lot management'}
                  </p>
                  
                  {/* Features */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-white/70 mb-6">
                ...
                <div className="flex flex-col items-center gap-4">
                  <button
                    disabled
                    className="bot-download-button group relative"
                  >
