...
import { CheckCircle, XCircle, Clock, Users, ShoppingCart, DollarSign, ArrowLeft, Star, BarChart3, Trophy, UserCheck, CreditCard, Bot, Gift, Download } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex gap-2 mb-6 flex-wrap">
          ...
          <Button
            ...
            className={`${activeTab === 'bonus' ? 'bg-gradient-to-r from-yellow-500 to-pink-600' : 'bg-white/10'}`}
          >
