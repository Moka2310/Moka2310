...
import { Users, Award, TrendingUp, Shield, Target, Heart, ArrowUp } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0A0118] via-[#1a0b2e] to-[#16213E] pt-32 px-4 pb-20">
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-gradient-to-r from-pink-500 to-purple-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all hover:scale-110 z-50"
