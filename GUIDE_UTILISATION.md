...
curl https://tradalife-platform.preview.emergentagent.com/api/formations

# Créer un utilisateur
curl -X POST https://tradalife-platform.preview.emergentagent.com/api/auth/register \
  -H "Content-Type: application/json" \
  -d '{"email":"test@test.com","password":"Test123!"}'
```

### Frontend
1. Ouvrir : https://tradalife-platform.preview.emergentagent.com
